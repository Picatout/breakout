...
extern void PCACH_0_enter_DefaultMode_from_RESET(void) {
	...
	/***********************************************************************
	 - PCA Channel 0 Capture Module Low Byte = 0x90
	 ***********************************************************************/
	PCA0CPL0 = (0x90 << PCA0CPL0_PCA0CPL0__SHIFT);
	// [PCA0CPL0 - PCA Channel 0 Capture Module Low Byte]$
...
extern void TIMER01_0_enter_DefaultMode_from_RESET(void) {
	...
	/***********************************************************************
	 - Timer 0 Low Byte = 0xF4
	 ***********************************************************************/
	TL0 = (0xF4 << TL0_TL0__SHIFT);
	// [TL0 - Timer 0 Low Byte]$
...
extern void TIMER16_2_enter_DefaultMode_from_RESET(void) {
	...
	/***********************************************************************
	 - Timer 2 Reload High Byte = 0xF9
	 ***********************************************************************/
	TMR2RLH = (0xF9 << TMR2RLH_TMR2RLH__SHIFT);
	// [TMR2RLH - Timer 2 Reload High Byte]$
...
extern void INTERRUPT_0_enter_DefaultMode_from_RESET(void) {
	...
	EIP1 = EIP1_PADC0__LOW | EIP1_PWADC0__LOW | EIP1_PCP0__LOW | EIP1_PCP1__LOW
			| EIP1_PMAT__LOW | EIP1_PPCA0__HIGH | EIP1_PSMB0__LOW
			| EIP1_PT3__LOW;
	// [EIP1 - Extended Interrupt Priority 1]$
...
extern void PCACH_1_enter_DefaultMode_from_RESET(void) {
	...
	/***********************************************************************
	 - PCA Channel 1 Capture Module Low Byte = 0xAE
	 ***********************************************************************/
	PCA0CPL1 = (0xAE << PCA0CPL1_PCA0CPL1__SHIFT);
	// [PCA0CPL1 - PCA Channel 1 Capture Module Low Byte]$
...
extern void PCACH_2_enter_DefaultMode_from_RESET(void) {
	...
	/***********************************************************************
	 - PCA Channel 2 Capture Module Low Byte = 0xD6
	 ***********************************************************************/
	PCA0CPL2 = (0xD6 << PCA0CPL2_PCA0CPL2__SHIFT);
	// [PCA0CPL2 - PCA Channel 2 Capture Module Low Byte]$

	// $[PCA0CPH2 - PCA Channel 2 Capture Module High Byte]
	/***********************************************************************
	 - PCA Channel 2 Capture Module High Byte = 0x01
	 ***********************************************************************/
	PCA0CPH2 = (0x01 << PCA0CPH2_PCA0CPH2__SHIFT);
	// [PCA0CPH2 - PCA Channel 2 Capture Module High Byte]$
